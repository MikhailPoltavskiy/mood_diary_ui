...
class $AssetsFontsGen {
  ...
  /// List of all assets
  List<String> get values => [nunitoBold, nunitoItalic, nunitoRegular];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/calm.png
  AssetGenImage get calm => const AssetGenImage('assets/images/calm.png');

  /// File path: assets/images/fear.png
  AssetGenImage get fear => const AssetGenImage('assets/images/fear.png');

  /// File path: assets/images/force.png
  AssetGenImage get force => const AssetGenImage('assets/images/force.png');

  /// File path: assets/images/joy.png
  AssetGenImage get joy => const AssetGenImage('assets/images/joy.png');

  /// File path: assets/images/rabies.png
  AssetGenImage get rabies => const AssetGenImage('assets/images/rabies.png');

  /// File path: assets/images/sadness.png
  AssetGenImage get sadness => const AssetGenImage('assets/images/sadness.png');

  /// List of all assets
  List<AssetGenImage> get values => [calm, fear, force, joy, rabies, sadness];
}
